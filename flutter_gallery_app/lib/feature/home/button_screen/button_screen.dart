...
class ButtonScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final buttonScreenState = context.watch<ButtonScreenCubit>().state;
    final buttonScreenCubit = context.read<ButtonScreenCubit>();
          ...
          child: Column(
            ...
            children: [
              DropdownButton<String>(
                ...
                value: buttonScreenState.dropdown,
                onChanged: (String? newValue) {
                  buttonScreenCubit
                      .updateDropdown(newValue ?? Constants.dropdownData.first);
                },
              ...
              DropdownButtonFormField<String>(
                hint: const Text('Select your favourite fruit'),
                value: buttonScreenState.dropdownFormField,
                onChanged: (String? newValue) {
                  buttonScreenCubit.updateDropdownFormField(
              ...
              ToggleButtons(
                ...
                onPressed: (int index) {
                  buttonScreenCubit.updateOptionState(index);
                },
                isSelected: buttonScreenState.options,
